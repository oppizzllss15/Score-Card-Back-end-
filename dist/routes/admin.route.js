...
const { loginAdmin, logoutAdmin, adminProfileImage, adminProfile, forgotAdminPassword, resetAdminPassGetPage, resetAdminPass, } = require("../controllers/admin.controller");
